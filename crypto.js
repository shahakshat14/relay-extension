...
// New vaults use PBKDF2(username, PEPPER) so users can sign in from a
// fresh browser with only username + password. accountSalt remains as a
// legacy fallback for vaults created during the short salted-key period.
